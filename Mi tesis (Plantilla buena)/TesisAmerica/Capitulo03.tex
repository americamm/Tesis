...
El objetivo de realizar la detección de objetos utilizando un clasificador en forma de cascada es descartar de manera rápida las regiones donde no se encuentra el objeto.  

\begin{figure}[h!]
\begin{center}
\includegraphics[scale=.3]{./Figures/pusheen.png}
\end{center}
