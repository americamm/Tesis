...
\begin{figure}[h!]
\centering 
\subfigure[Dispositivos basados en contacto: en la parte izquierda de la imagen se observan los guantes de datos \protect\footnotemark, en el centro los guantes de colores \footnotetext{http://www.technologyreview.com/article/414021/open-source-data-glove/} \protect\footnotemark y a la derecha se encuentra el dispositivo wii \footnotetext{http://www.digitaltrends.com/computing/the-gloves-that-could-change-the-world/} \protect\footnotemark{} \footnotetext{https://www.nintendo.es/Wii/Wii-94559.html} ]
{
...
\subfigure[Dispositivos basados en visión: en la imagen se observan distintos tipos de cámaras en la parte izquierda de la imagen se observa una web \footnotemark{}, en el centro una digital \footnotemark{} y a la derecha de la imagen una TOF \protect\footnotemark{}.]
{
...
La sección anterior explica los modelos utilizados para llevar acabo el reconocimiento de gestos, enseguida se presentan los trabajos relevantes de cada uno de estos enfoques y también se mencionan algunos de los sistemas comerciales importantes. 

\subsection{Modelos de contacto}
 
Como se menciono en la sección anterior los primeros trabajos de reconocimiento de gestos utilizaba este modelo, actualmente se sigue utilizando pero en menor grado. En los párrafos siguientes se presentan dos trabajos relevantes en esta área. 
