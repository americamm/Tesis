...
\begin{figure}%[htbp]
\centering
\subfigure[Rectángulo de $3x3$]{\includegraphics[scale=.4]{./Figures/EX1}\label{fig:EX:1}}
\subfigure[Figura de $3x3$]{\includegraphics[scale=.4]{./Figures/EX3}\label{fig:EX:3}} \\
\subfigure[Cruz de $5x5$]{\includegraphics[scale=.4]{./Figures/EX2}\label{fig:EX:2}}
