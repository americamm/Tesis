...
\tituloIN{Computer control based in hand gestures in circumstances of low ilumination}
...
\fechaexamen{Octubre, 2015}\fechaexamenIN{September, 2015}
...
\keywords{Hand gestures, kinect, low ilumination, oclussion.}
...
{\normalsize
%TCIMACRO{\QSubDoc{Include Capitulo01}{\input{Capitulo01.tex}} }%
%BeginExpansion
...
{\normalsize
%TCIMACRO{\QSubDoc{Include Capitulo02}{\input{Capitulo02.tex}} }%
%BeginExpansion
...
{\normalsize
%TCIMACRO{\QSubDoc{Include Capitulo03}{\input{Capitulo03.tex}} }%
%BeginExpansion
...
{\normalsize
%TCIMACRO{\QSubDoc{Include Capitulo04}{\input{Capitulo04.tex}} }%
%BeginExpansion
...
{\normalsize
%TCIMACRO{\QSubDoc{Include Capitulo05}{\input{Capitulo05.tex}} }%
%BeginExpansion
